...
if __name__ == '__main__':
    ...
    ## given the pose of end effector, pick up and place
    #--------- pick up the object ------------#
    # 1. Move to a random position
    fa.goto_pose(random_position, joint_impedances=[100, 100, 100, 50, 50, 100, 100])
    ## 2. Open Grippers
    print('Opening Grippers')
    fa.open_gripper()
    ## 3. Move to the object
    fa.goto_pose(xtranslation_3cm, joint_impedances=[100, 100, 100, 50, 50, 100, 100])
    ## 4. Close Grippers
